...
export function PageHeader({ title, description, actions }: PageHeaderProps) {
  return (
    <div className="relative flex flex-col gap-4 overflow-hidden rounded-2xl border border-primary/10 bg-card/80 px-5 py-5 shadow-card backdrop-blur-sm sm:flex-row sm:items-center sm:justify-between lg:px-6">
